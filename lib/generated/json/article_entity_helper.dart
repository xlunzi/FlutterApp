...
articleDataFromJson(ArticleData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = new List<ItemData>();
		(json['datas'] as List).forEach((v) {
			data.datas.add(new ItemData().fromJson(v));
		});
	}
	if (json['offset'] != null) {
...
itemDataFromJson(ItemData data, Map<String, dynamic> json) {
...
Map<String, dynamic> itemDataToJson(ItemData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
